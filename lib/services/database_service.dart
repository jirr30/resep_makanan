...
class DatabaseService {
    ...
    final samples = [
      {
        ...
        'cookingTime': 20, 'servings': 2, 'rating': 4.5, 'userRating': 0.0, 'difficulty': 'Mudah', 'isFavorite': 0,
        'calories': 450, 'protein': 12.0, 'carbs': 70.0, 'fat': 14.0,
      },
      {
        'title': 'Soto Ayam',
        'category': 'Sup',
        ...
        'cookingTime': 60, 'servings': 4, 'rating': 4.8, 'userRating': 0.0, 'difficulty': 'Sedang', 'isFavorite': 0,
        'calories': 320, 'protein': 28.0, 'carbs': 25.0, 'fat': 10.0,
      },
      {
        ...
        'cookingTime': 180, 'servings': 6, 'rating': 4.9, 'userRating': 0.0, 'difficulty': 'Sulit', 'isFavorite': 0,
        'calories': 580, 'protein': 35.0, 'carbs': 10.0, 'fat': 42.0,
      },
      {
        'title': 'Gado-Gado',
        'category': 'Salad',
        ...
        'cookingTime': 40, 'servings': 4, 'rating': 4.3, 'userRating': 0.0, 'difficulty': 'Mudah', 'isFavorite': 0,
        'calories': 380, 'protein': 18.0, 'carbs': 35.0, 'fat': 20.0,
      },
      {
        ...
        'cookingTime': 45, 'servings': 8, 'rating': 4.7, 'userRating': 0.0, 'difficulty': 'Sedang', 'isFavorite': 0,
      ...
      },
      {
        ...
        'cookingTime': 50, 'servings': 4, 'rating': 4.6, 'userRating': 0.0, 'difficulty': 'Sedang', 'isFavorite': 0,
        'calories': 340, 'protein': 30.0, 'carbs': 15.0, 'fat': 18.0,
      },
    ];
  ...
  Future<void> addCustomCategory(String name) async {
    final db = await database;
    await db.insert('custom_categories', {'name': name},
